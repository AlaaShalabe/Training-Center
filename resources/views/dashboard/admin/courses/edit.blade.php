            ...
            <div class="card">
                ...
                <form method="post" action="{{ route('courses.update', $course) }}" autocomplete="off"
                    ...
                    <div class="card-body">
                        ...
                        @if ($course->image)
                            <img src="{{ asset($course->image) }}" alt="Old Photo" width="90" height="90">
                        @endif
                        {{-- Name --}}
                        <div class="col-md-10">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="Enter the name " value="{{ old('name', $course->name) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" name="price"
                                    ...
                                    placeholder="Enter the price " value="{{ old('price', $course->price) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('maximum') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" name="maximum"
                                    ...
                                    placeholder="Enter the maximum " value="{{ old('maximum', $course->maximum) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('minimum') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" name="minimum"
                                    ...
                                    placeholder="Enter the minimum " value="{{ old('minimum', $course->minimum) }}">
                        ...
                        <div class="col-md-10">
                            <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                ...
                                <textarea type="text" name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                    placeholder="Enter the description ">{{ old('description', $course->description) }}</textarea>
